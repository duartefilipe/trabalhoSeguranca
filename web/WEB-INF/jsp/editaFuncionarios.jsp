...
<div class="container">
    <div class="container"><br><br>
        <h1 align="center">Altera Funcionario: </h1>
    </div>
    ...
    <form action="criaFuncionario.priv" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nome" id="nome" value="<c:out value='${funcionario.nome}'/>">
        </div>

        <div class="form-group">
            <label for="login" class="col-form-label">Login:</label>
            <input type="text" class="form-control" name="login" id="login" value="<c:out value='${funcionario.login}'/>">
        </div>
    ...
    <table class="table table-striped">
        <tr>
            ...
            <tr>
                ...
                <td>${f.login}</td>
                <td>
                    <a href="editaFuncionario.priv" > Editar </a>
                </td>
                <td>
