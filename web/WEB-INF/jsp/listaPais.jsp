...
<div class="container">
    <div class="container"><br><br>
        <h1 align="center">Cadastrar Pais: </h1>
    </div>

    <form action="criaPais.priv" method="post">
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${pais}" var="p">
            <tr>
                <td>${p.nome}</td>
                <td>
                    <a href="paginaEditaPais.priv?&id=${p.id}"> Editar </a>
                </td>
                <td>
                    <a href="removePais.priv?&id=${p.id}"> Remover </a>
                </td>
            </tr>
        </c:forEach>
    </table>
