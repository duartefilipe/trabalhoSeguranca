...
<div class="container">
    <div class="container"><br><br>
        <h1 align="center">Criar novo Post: </h1>
    </div>

<form action="criaPost.priv" method="post">
...
<table class="table table-striped">
    ...
    <c:forEach items="${posts}" var="p">
        <tr>
            ...
            <td>${p.texto}</td>
            <td>
                <a href="paginaEditaPost.priv?&id=${p.idpost}"> Editar </a>
            </td>
            <td>
                <a href="removePost.priv?&id=${p.idpost}"> Remover </a>
            </td>
        </tr>
    </c:forEach>
</table>
